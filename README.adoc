...
For more detailed documentation please see: http://i-cell-mobilsoft-open-source.github.io/coffee/en/[coff:ee documentation]
...
Bővebb leírás a http://i-cell-mobilsoft-open-source.github.io/coffee/hu/[coff:ee dokumentáció] oldalon található.
