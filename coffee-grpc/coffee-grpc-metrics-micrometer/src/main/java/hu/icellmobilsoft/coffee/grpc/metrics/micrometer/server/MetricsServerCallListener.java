...
public class MetricsServerCallListener<ReqT> extends ForwardingServerCallListener<ReqT> {
    ...
    public void onMessage(ReqT message) {
        metricBundle.getRequestCounter().increment();
    ...
    private void updateTimer(Code responseCode) {
        metricBundle.getTimerCodeFunction().apply(responseCode).record(Duration.between(metricBundle.getStartTime(), LocalDateTime.now()));
    }
