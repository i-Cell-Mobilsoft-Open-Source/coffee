...
.enable gRPC server metrics - https://github.com/eclipse/microprofile-metrics[microprofile-metrics] implementation
[source,xml]
----
<dependency>
...
<dependency>
    <groupId>hu.icellmobilsoft.coffee</groupId>
    <artifactId>coffee-grpc-metrics-impl</artifactId>
</dependency>
----

.enable gRPC client metrics - https://github.com/eclipse/microprofile-metrics[microprofile-metrics] implementation
[source,xml]
----
<dependency>
    <groupId>hu.icellmobilsoft.coffee</groupId>
