...
== OpenApiFilter
A Microprofile OpenApi lehetőséget biztos az org.eclipse.microprofile.openapi.OASFilter interface implementációján keresztül további OpenApi configuráció beállításhoz.
