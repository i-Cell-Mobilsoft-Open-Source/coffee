    ...
    <build>
        <plugins>
            <plugin>
				...
				<configuration>
					<target>
						<!--https://eclipse-ee4j.github.io/jaxb-ri/4.0.1/docs/ch04.html#tools-xjc-ant-task-->
						<taskdef name="register-maven-url-handler"
								 classname="hu.icellmobilsoft.coffee.se.net.task.MavenURLHandlerRegistrationTask"/> //<11>
						<taskdef name="xjc" classname="com.sun.tools.xjc.XJCTask"/> //<3>

						<property name="generateDirectory"
								  value="${project.build.directory}/generated-sources/src/main/java"/> //<7>
						<!-- handle maven: url protocols-->
						<register-maven-url-handler/>

						<mkdir dir="${generateDirectory}"/>
						<mkdir dir="${generateDirectory}/META-INF"/>

						<xjc destdir="${generateDirectory}"
							 catalog="src/main/resources/xsd/hu/icellmobilsoft/coffee/dto/super.catalog.xml" //<4>
							 extension="true">

							<schema dir="src/main/resources" includes="xsd/hu/icellmobilsoft/coffee/dto/super.xsd"/> //<5>
							<binding dir="src/main/resources" includes="xsd/hu/icellmobilsoft/coffee/dto/bindings.xjb"/> //<6>

							<arg value="-verbose"/>

							<!-- plugin kapcsolók -->
							<arg value="-openapify"/>  //<8>
							<arg value="-Xfluent-api"/> //<9>
                ...
                <dependencies>
					<dependency>
						...
						<artifactId>jaxb-xjc</artifactId> //<10>
						<version>4.0.1</version>
						<scope>compile</scope>
					</dependency>
					<dependency>
						<groupId>com.sun.xml.bind</groupId>
						<artifactId>jaxb-impl</artifactId> //<10>
						<version>4.0.1</version>
						<scope>compile</scope>
					</dependency>
					<dependency>
						<groupId>hu.icellmobilsoft.coffee</groupId>
						<artifactId>coffee-se-net</artifactId> //<11>
...
<3> Ant task mely vezérli a generálást
...
<8> Kapcsoló hogy generálja az OpenApi annotációkat, `hu.icellmobilsoft.jaxb:openapi-jaxb` plugin által.
...
<10> Generáláshoz használt jaxb és xjc implementáció
<11> A `maven:` url protokoll feloldásához szükséges
...
----
include::../../coffee-se/coffee-se-net/src/main/java/hu/icellmobilsoft/coffee/se/net/MavenURLHandler.java[lines=30..45]
----
