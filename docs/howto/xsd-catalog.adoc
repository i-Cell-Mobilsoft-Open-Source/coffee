    ...
    <build>
        <plugins>
            <plugin>
                ...
                <artifactId>maven-jaxb2-plugin</artifactId> //<3>
                ...
                <configuration>
                    ...
                    <plugins>
                        <plugin>
                            ...
                            <artifactId>openapi-jaxb</artifactId> //<8>
...
.swagger UI
image::pic/XSD_catalog_swaggerUI_sample.png[]
...
. Valami ilyesmi fogunk látni: image:pic/XSD_catalog_catalog_delete.png[title="Eclipse Catalog Törlés"]
