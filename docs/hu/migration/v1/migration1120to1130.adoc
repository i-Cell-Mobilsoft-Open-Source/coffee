...
* A `BaseRestLogger` osztály optimalizáláson esett át, aminek eredményeképpen az alkalmazások kevesebb memóriát használnak fel a request és response body log-olás során.
