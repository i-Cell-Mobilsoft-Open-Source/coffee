...
<3> A generált JSON `customValues` értékeit tartalmazza. Formátuma: `KEY=VALUE; [KEY=VALUE...]`. DEFAULT: üres
<4> A generált JSON-t a classpath-ra kell-e rakni, azaz szeretnénk-e, hogy az elkészült jar fájlba bekerüljön. Default: `true`
<5> A JSON generáláshoz használt `jakarta.json.spi.JsonProvider` implementáció konkrét típusa. Default: `org.eclipse.parsson.JsonProviderImpl`
