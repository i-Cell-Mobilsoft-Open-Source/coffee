        ...
        <plugin>
            ...
            <configuration>
                <compilerArgs>
                    ...
                    <arg>-Acoffee.repserv.config.generated.json.customValues=key1=value1;key2=value2</arg> #<3>
                    <arg>-Acoffee.repserv.config.generated.outputToClasspath=false</arg> #<4>
                    <arg>-Acoffee.repserv.config.json.provider=org.eclipse.parsson.JsonProviderImpl</arg> #<5>
                </compilerArgs>
            </configuration>
        </plugin>
    </plugins>
...
<3> The generated JSON `customValues` are contained in. Format: `KEY=VALUE; [KEY=VALUE...]`. DEFAULT: empty
<4> Whether the generated JSON should be put on the classpath, i.e. whether we want it to be included in the generated jar file. Default: `true`
<5> The `jakarta.json.spi.JsonProvider`, which is used to generate JSON, implementation concrete type. Default: `org.eclipse.parsson.JsonProviderImpl`
