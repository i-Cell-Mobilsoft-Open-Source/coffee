...
==== Átállás
* A változtatások nem eredményeznek átállási munkálatokat, visszafelé kompatibilis.
* Kivétel a DefaultBaseExceptionMapper-re átállás. Ha van projekt specifikus kivétel amit kezelni szeretnénk, akkor ki
...
----
<1> @Priority szükséges, mivel enélkül figyelmen kívül hagyja az egész osztályt, és a DefaultBaseExceptionMapper működése marad életben
