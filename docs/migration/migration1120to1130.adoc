...
* Átalakításra került a 'DefaultGeneralExceptionMapper' és a 'DefaultBaseExceptionMapper' osztályokban a hibakezelés.
...
* Az visszafelé kompatibilításhoz a projekteken saját ExceptionMapper létrehozása szükséges.
