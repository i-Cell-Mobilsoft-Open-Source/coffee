...
class BatchServiceTest {
    ...
    void setPsObjectDateWithoutTimezoneTest(BasicType<?> type, Object value) throws SQLException {
    ...
    void setPsObjectTimeAndTimestampWithoutTimezoneTest(BasicType<?> type, Object value) throws SQLException {
        batchService.setPsObject(preparedStatement, 0, type, value);
        Mockito.verify(preparedStatement).setObject(0, value, 0);
    }

    @Order(3)
    @ParameterizedTest(name = "[{index}] - type: [{0}] value: [{1}]")
    @MethodSource("provideDateTypes")
    void setPsObjectDateWithTimezoneTest(BasicType<?> type, Object value) throws SQLException {
    ...
    void setPsObjectTimeWithTimezoneTest(BasicType<?> type, Object value, Object expectedValue) throws SQLException {
    ...
    void setPsObjectTimestampWithTimezoneTest(BasicType<?> type, Object value, Object expectedValue) throws SQLException {
        // BatchService-ben lévő dbTimeZone mock készítése miatt szükségesek
        mockDbTimeZone();
        Mockito.doReturn(UTC_ZONE_ID).when(dbTimeZone).toZoneId();
