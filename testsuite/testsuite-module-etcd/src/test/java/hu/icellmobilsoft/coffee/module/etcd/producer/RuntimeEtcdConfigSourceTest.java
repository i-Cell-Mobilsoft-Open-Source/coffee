 ...
 * @since 2.6.0
 */
@DisplayName("Testing RuntimeEtcdConfigSource")
@TestMethodOrder(OrderAnnotation.class)
public class RuntimeEtcdConfigSourceTest extends BaseEtcdTest {
    ...
    @Order(200)
    public void existKeyNotActive() throws BaseException {
        assertAllEtcdConfigSource();
    ...
    @Order(300)
    public void existKeyActive() throws BaseException {
        assertAllEtcdConfigSource();
        configEtcdHandler.putValue(TEST_KEY2, TEST_VALUE);
        RuntimeEtcdConfigSource.setActive(true);

        String value = ConfigProvider.getConfig().getOptionalValue(TEST_KEY2, String.class).orElse(NO_VALUE);
