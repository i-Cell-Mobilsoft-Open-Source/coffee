...
//        Class targetClass = context.getTarget() != null ? context.getTarget().getClass() :
        ...
        Transactional methodT = context.getMethod().getAnnotation(Transactional.class);
        Transactional classT = targetClass.getAnnotation(Transactional.class);
        return methodT != null ? methodT : classT;
