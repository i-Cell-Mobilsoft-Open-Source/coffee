...
public class OrderByQueryPart extends BasePropertyQueryPart
{
    ...
    private static enum Direction
    {
        ...
        {
            return postfix != null && !postfix.isEmpty() ? queryPart.endsWith(postfix) : false;
//            return isNotEmpty(postfix) ? queryPart.endsWith(postfix) : false;
        }

        public String attribute(String queryPart)
        {
            String attribute = postfix != null && !postfix.isEmpty() ?
        ...
        {
            return postfix != null && !postfix.isEmpty() ? " " + postfix.toLowerCase() : "";
        }
