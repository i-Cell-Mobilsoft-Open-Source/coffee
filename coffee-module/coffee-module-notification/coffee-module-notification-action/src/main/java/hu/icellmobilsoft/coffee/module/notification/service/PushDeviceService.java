...
/**
 * Service for {@link PushDevice} functionality. Represents only DB operations
 *
 * @author karoly.tamas
 * @since 1.0.0
 */
@Dependent
public class PushDeviceService extends BaseService<PushDevice> implements Serializable {
