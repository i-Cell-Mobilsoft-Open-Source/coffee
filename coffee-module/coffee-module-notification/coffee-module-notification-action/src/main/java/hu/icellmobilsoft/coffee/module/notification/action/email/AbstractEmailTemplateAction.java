 ...
 */
@Dependent
public abstract class AbstractEmailTemplateAction implements Serializable {
    ...
    public void sendAndSave(EmailTemplateType emailType) throws BaseException {
        ...
        // email template
        TemplateFullType template = getTemplate(emailType.getTemplateKey(), emailType.getParameter(), emailType.getLanguage());
        emailDataBase.setSubject(template.getSubject());
        emailDataBase.setBody(new String(template.getData()));
