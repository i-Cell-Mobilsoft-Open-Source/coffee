...
public @interface RedisStreamConnection {
    ...
    /**
     * Supports inline instantiation of the {@link RedisStreamConnection} qualifier.
     *
     * @author peter.kovacs
     */
    public static final class Literal extends AnnotationLiteral<RedisStreamConnection> implements RedisStreamConnection {
