 ...
 * #L%
 */
package hu.icellmobilsoft.coffee.module.mp.micrometer.test;
...
import hu.icellmobilsoft.coffee.module.mp.micrometer.JedisMicrometerHandler;
import io.micrometer.core.instrument.MeterRegistry;

/**
 * Testing Micrometer producer CDI resolver
 * 
...
class JedisMicrometerHandlerTests {
    ...
    public WeldInitiator weld = WeldInitiator.from(WeldInitiator.createWeld()
            // beans.xml scan
            .enableDiscovery()).addBeans(MockBean.of(mock(MeterRegistry.class), MeterRegistry.class))
            // start request scope + build
            .build();

    @Test
    @DisplayName("Micrometer handler test")
    void micrometerHandler() {
        ...
        // must be JedisMicrometerHandler
        Assertions.assertInstanceOf(JedisMicrometerHandler.class, instance);
    }
