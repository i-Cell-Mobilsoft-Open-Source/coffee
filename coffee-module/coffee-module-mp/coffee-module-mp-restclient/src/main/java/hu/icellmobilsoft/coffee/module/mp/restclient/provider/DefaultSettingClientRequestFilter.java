...
/**
 * Rest Client default request setting filter. Setting up the sessionId variable to be passed through services to facilitate logging and authentication mechanisms.
 *
