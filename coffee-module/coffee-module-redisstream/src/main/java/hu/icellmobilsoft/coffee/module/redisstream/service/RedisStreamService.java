...
public class RedisStreamService {
    ...
    public void handleGroup() throws BaseException {
        if (existsGroupInActiveConnection()) {
            ...
            Optional<String> createGroupResult = getRedisManager().run(UnifiedJedis::xgroupCreate, "xgroupCreate", streamKey(), getGroup(),
    ...
    /**
     * Creates the parameters for the {@link UnifiedJedis#xreadGroup}
     *
     * @return params for {@link UnifiedJedis#xreadGroup}
     */
